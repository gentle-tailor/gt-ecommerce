...
export const PATH_CUSTOMIZE_ACCENT = `${PATH_CUSTOMIZE}/accent`;
export const PATH_CUSTOMIZE_CONFIRM = `${PATH_CUSTOMIZE}/confirm`;
...
export const PATH_ORDER_CONFIRM = `${PATH_ORDER}/confirm`;

export const PATH_SHOP = `${PATH_ROOT}/shop`;
export const PATH_SHOP_PRESET = `${PATH_SHOP}/:identifier`;
